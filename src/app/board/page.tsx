...
const DEMO_CLIENTES: Cliente[] = [
  { id: 'c1', nome: 'Banco XP', dominio: null, cor: null, drive_folder_url: null, created_at: '' },
  { id: 'c2', nome: 'Natura', dominio: null, cor: null, drive_folder_url: null, created_at: '' },
  { id: 'c3', nome: 'Itaú', dominio: null, cor: null, drive_folder_url: null, created_at: '' },
  { id: 'c4', nome: 'Ambev', dominio: null, cor: null, drive_folder_url: null, created_at: '' },
  { id: 'c5', nome: 'Magazine Luiza', dominio: null, cor: null, drive_folder_url: null, created_at: '' },
]
...
const DEMO_JOBS: Job[] = [
  {
    ...
    cliente: { id: 'c1', nome: 'Banco XP', dominio: null, cor: null, drive_folder_url: null, created_at: '' },
  },
  {
    ...
    created_at: '', created_by: '',
    cliente: { id: 'c2', nome: 'Natura', dominio: null, cor: null, drive_folder_url: null, created_at: '' },
  },
  {
    ...
    created_at: '', created_by: '',
    cliente: { id: 'c3', nome: 'Itaú', dominio: null, cor: null, drive_folder_url: null, created_at: '' },
  },
  {
  ...
  },
  {
    ...
    created_at: '', created_by: '',
    cliente: { id: 'c4', nome: 'Ambev', dominio: null, cor: null, drive_folder_url: null, created_at: '' },
  },
  {
    ...
    created_at: '', created_by: '',
    cliente: { id: 'c5', nome: 'Magazine Luiza', dominio: null, cor: null, drive_folder_url: null, created_at: '' },
  },
]
